...
epi{1}(125:150,55:115)= c_eps_0*11.3;
epi{1}(125:60,20:85)= c_eps_0*11.3;
epi{1}(125:150,20:85)= c_eps_0*11.3;
epi{1}(125:60,55:115)= c_eps_0*11.3;
...
% some parameters and variables to play around
bc{1}.NumS = 1;
bc{1}.s(1).xpos = nx{1}/(4) + 1;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
% mag = -1/c_eta_0;
mag = 1;        % will increase/decrease the magnitude of wave propagated
phi = 0;        % initial phase
omega = f*2*pi; % angular frequency
betap = 0;      
t0 = 30e-15;    
%st = 15e-15;
st = -0.05; % seems it's causing lots of reflections
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
